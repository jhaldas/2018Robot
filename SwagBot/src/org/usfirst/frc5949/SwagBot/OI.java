...
import org.usfirst.frc5949.SwagBot.commands.*;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;
import edu.wpi.first.wpilibj.Joystick;
import edu.wpi.first.wpilibj.buttons.JoystickButton;

import org.usfirst.frc5949.SwagBot.subsystems.*;
...
public class OI {
    ...
    public OI() {
        ...
        clawClose = new JoystickButton(joystick, 5);
        clawClose.whileHeld(new CloseClaw());
        clawOpen = new JoystickButton(joystick, 6);
        clawOpen.whileHeld(new OpenClaw());
        liftDown = new JoystickButton(joystick, 3);
        liftDown.whileHeld(new Lower());
        liftUp = new JoystickButton(joystick, 4);
        liftUp.whileHeld(new Lift());
